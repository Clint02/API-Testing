...
const getAllData = async ()=>{
    try {
        const response = await (0, _axiosDefault.default).get(`${baseURL}/products`);
...
const getDatabyID = async ()=>{
    try {
        const response = await (0, _axiosDefault.default).get(`${baseURL}/products/5`);
...
const postData = async ()=>{
    try {
        const response = await (0, _axiosDefault.default).post(`${baseURL}/products/add`, {
...
const putData = async ()=>{
    try {
        const response = await (0, _axiosDefault.default).put(`${baseURL}/products/5`, {
...
const deleteData = async ()=>{
    try {
        const response = await (0, _axiosDefault.default).delete(`${baseURL}/products/1`);
...
const getRestrictedData = async ()=>{
    try {
        ...
        const authResponse = await (0, _axiosDefault.default).post(`${baseURL}/auth/login`, {
            username: "alexanderj",
        ...
        const secureResponse = await (0, _axiosDefault.default).get(`${baseURL}/auth/users`, authConfig);
